/**
 * SVG Icons for Attendance System
 * Replaces emoji icons for better consistency and clarity
 */
...
export const ShoesIcon = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <ellipse cx="12" cy="18" rx="10" ry="4"></ellipse>
    <path d="M3 14c0-2.2 4.5-4 10-4s10 1.8 10 4"></path>
    <path d="M12 4v6"></path>
...
export const CleanIcon = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 12h4l3 9 4-17 3 8h4"></path>
  </svg>
);
